...
def test_discharge_all_returns_four():
...
def test_lean_file_contains_all_four_theorems():
    src = _LEAN_FILE.read_text()
    for name in ["autodischarge_001", "autodischarge_003",
                 "autodischarge_004", "autodischarge_006"]:
